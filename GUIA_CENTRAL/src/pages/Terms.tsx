...
import { CheckCircle2, XCircle, AlertCircle, Mail, User, RefreshCw, FileText, Smartphone, Clock, DollarSign, Shield, Ban, Lightbulb } from "lucide-react";

const Terms = () => {
  return (
    <Layout>
      <SEOHead
        title="Termos de Uso - Guia Central"
        description="Leia os termos de uso do Guia Central antes de utilizar nossos serviços."
      />
        ...
        <div className="container max-w-4xl mx-auto px-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 border-l-4 border-blue-500 rounded-lg p-6 mb-8">
            ...
            <p className="text-blue-800 dark:text-blue-200 text-sm">
              O uso do site guia-central.online e a contratação dos nossos serviços demonstra a sua concordância integral com estes Termos de Uso.
            </p>
          </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-foreground mb-6">
              O site Guia Central (guia-central.online) é uma <strong>plataforma privada de automação documental</strong> que utiliza inteligência artificial para orientar o usuário e automatizar o processamento de documentos digitais.
            </p>
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-card border rounded-lg p-5">
                ...
                <p className="text-sm text-muted-foreground">O site guia-central.online e seus serviços.</p>
              </div>
              <div className="bg-card border rounded-lg p-5">
                <div className="flex items-center gap-3 mb-2">
          ...
          <section className="mb-10">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border-l-4 border-blue-500 rounded-lg p-5">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200">
                <strong>Prazo para solicitar:</strong> até 7 dias via e-mail contato@guia-central.online
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-foreground">
              Todo o conteúdo do site (textos, imagens, logotipos, etc.) é de propriedade do Guia Central LTDA e está protegido por direitos autorais.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border-l-4 border-blue-500 rounded-lg p-5">
              ...
              <p className="text-blue-800 dark:text-blue-200 mb-1"><strong>E-mail:</strong> contato@guia-central.online</p>
