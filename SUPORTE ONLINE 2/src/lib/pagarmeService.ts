...
export async function createPixTransaction(
  ...
  try {
    ...
    console.log('📦 [Suporte Online 2] Criando transação PIX via sync-server...', {
      url,
    ...
    console.log('📤 [Suporte Online 2] Payload enviado:', {
      ...payload,
      customer: {
        ...payload.customer,
    ...
    console.log('📥 [Suporte Online 2] Resposta recebida:', {
    ...
    if (!response.ok) {
      ...
      console.error('❌ [Suporte Online 2] Erro ao criar transação:', {
        status: response.status,
        statusText: response.statusText,
        errorData,
      });
    ...
    console.log('✅ [Suporte Online 2] Transação criada via sync-server:', {
      id: transaction.id,
...
export async function getTransactionStatus(
  ...
  try {
    ...
    console.error('❌ [Suporte Online 2] Erro ao consultar transação:', error);
    throw error;
  }
}
